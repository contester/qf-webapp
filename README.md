...
- Кликабельная ошибка компиляции с полным логом - по ссылке на модале из статуса и в деталях сабмита у участников
...
- Под задачей показывать количество команд которые её решили
